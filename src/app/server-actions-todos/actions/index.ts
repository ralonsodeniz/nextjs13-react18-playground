...
export const addTodo = async (data: FormData, client = false) => {
  ...
  if (todo) {
    ...
    const pathToRevalidate = client
      ? ROUTES.SERVER_ACTIONS_TODOS_CLIENT.href
      : ROUTES.SERVER_ACTIONS_TODOS.href;
